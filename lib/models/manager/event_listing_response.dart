class EventListingResponse {
  ...
  EventListingResponse.fromJson(Map<String, dynamic> json) {
...
class Body {
  ...
  late final List<dynamic> eventBookings;
  ...
  Body.fromJson(Map<String, dynamic> json) {
    ...
    eventImages = List.from(json['event_images'])
        ...
        .toList();
    eventBookings = List.castFrom<dynamic, dynamic>(json['event_bookings']);
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['event_bookings'] = eventBookings;
    return _data;
  }
}
