...
class UserBookingScreen extends StatefulWidget {
  ...
  @override
  State<UserBookingScreen> createState() => _UserHomeScreenState();
}

class _UserHomeScreenState extends State<UserBookingScreen> {
  ...
  Future<EventBookingListResponse> eventListingApi(BuildContext ctx) async {
    ...
    var value = isSelectCurrent ? 'current' : 'past';
    var response = await http.get(
        Uri.parse(GlobalVariable.baseUrl + GlobalVariable.bookingList + value),
